...
public class LoginController {
    ...
    @GetMapping("/login")
    public String login(@RequestParam(value = "url", defaultValue = "https://playlist.webius.net/") String url,
                        ModelMap modelMap) {
    ...
    public ModelAndView login(@RequestParam("id") String id,
                              ...
                              @RequestParam(value = "url", defaultValue = "https://playlist.webius.net/") String url,
    ...
    @GetMapping("/logout")
    public ModelAndView logout(@RequestParam(value = "rturl", defaultValue = "https://playlist.webius.net/") String url,
                               HttpServletRequest request,
                               ModelAndView modelAndView) {

...
public class LoginGoogleController {
    ...
    public ModelAndView loginGoogleInit(@RequestParam(value = "url", defaultValue = "https://playlist.webius.net/") String url,
        ...
        modelAndView.setView(MVCUtil.redirect(loginGoogleService.init(STATE)));
        return modelAndView;
    }
    ...
    public String loginGoogleCallback(@RequestParam(value = "code", required = false) String code,
        ...
        // 정상 접근의 경우
        LoginGoogleCodeVO googleCode = loginGoogleService.request(code);

...
<c:if test="${agent.matches('(pc|tablet|mac)')}">
    ...
    <script src="//playlist.webius.net/res/js/api/naver-tvcast-PrismPlayer_200803.js"></script>
    <script src="//playlist.webius.net/res/js/api/naver-tvcast-BaseWrapPlayer_200803.js"></script>
    <script src="//playlist.webius.net/res/js/api/naver-tvcast-EmbedPlayer_200803.js"></script>
    <script src="//playlist.webius.net/res/js/api/naver-tvcast-LikeItController_200803.js"></script>
    <script src="//playlist.webius.net/res/js/api_naver.js"></script>
</c:if>
...
<c:if test="${agent.matches('(mobile)')}">
    ...
    <!-- 200803 이후 변경된 JS 파일 추가 -->
    <script src="//ssl.pstatic.net/img.tvcast/pc/js/eg/eg.1.3.0.pkgd.min.js"></script>
    <script src="//playlist.webius.net/res/js/api/naver-tvcast-EmbedPlayer_200703.js"></script>
    <script src="//playlist.webius.net/res/js/api_naver_mobile.js"></script>
</c:if>
